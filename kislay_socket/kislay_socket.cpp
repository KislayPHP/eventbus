successfully downloaded text file (SHA: ac2f23b8c67cc20309e18215581bfc17d4405230)extern "C" {
#include "php.h"
...
PHP_MINIT_FUNCTION(kislayphp_eventbus) {
    ...
    INIT_NS_CLASS_ENTRY(ce, "Kislay\\EventBus", "Ack", kislay_ack_methods);
    ...
    INIT_NS_CLASS_ENTRY(ce, "Kislay\\EventBus", "Namespace", kislay_namespace_methods);
